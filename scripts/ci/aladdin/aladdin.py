...
examples:
  - name: Update a task for an Azure Container Registry. (autogenerated)
    text: az acr task update --arg DOCKER_CLI_BASE_IMAGE=docker:18.03.0-ce-git --base-image-trigger-enabled true --context https://github.com/Azure-Samples/acr-build-helloworld-node.git --file testtask.yaml --git-access-token 0000000000000000000000000000000000000000 --image MyImage --image MyImage --name MyTask --registry MyRegistry
    crafted: true
  - name: Update a task for an Azure Container Registry. (autogenerated)
    text: az acr task update --commit-trigger-enabled true --context https://github.com/Azure-Samples/acr-build-helloworld-node.git --git-access-token 0000000000000000000000000000000000000000 --name MyTask --registry MyRegistry
    crafted: true
"""
...
aladdin_helps['ams account-filter delete'] = """
type: command
...
examples:
  - name: List all the live outputs in a live event. (autogenerated)
    text: az ams live-output list --account-name MyAccount --live-event-name MyLiveEvent --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['batch job all-statistics show'] = """
type: command
...
examples:
  - name: Get lifetime summary statistics for all of the jobs in a Batch account. (autogenerated)
    text: az batch job all-statistics show --account-name MyAccount
    crafted: true
"""
...
aladdin_helps['batchai workspace delete'] = """
type: command
short-summary: Delete a workspace.
examples:
  - name: Delete a workspace. (autogenerated)
    text: az batchai workspace delete --resource-group MyResourceGroup --subscription MySubscription --workspace MyWorkspace
    crafted: true
"""
...
aladdin_helps['cdn endpoint load'] = """
type: command
short-summary: Pre-load content for a CDN endpoint.
examples:
  - name: Pre-load content for a CDN endpoint. (autogenerated)
    text: az cdn endpoint load --content-paths '/scripts/app.js' '/styles/main.css' --name endpoint --profile-name profile-name --resource-group group --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Show budget for an Azure subscription. (autogenerated)
    text: az consumption budget show --budget-name MyBudget --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create an MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb mongodb database create --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup --throughput "500"
    crafted: true
"""
...
examples:
  - name: Show the details of a MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb mongodb database show --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['iot hub message-enrichment list'] = """
type: command
...
examples:
  - name: Get information on all message enrichments for your IoT Hub (commonly used with --output). (autogenerated)
    text: az iot hub message-enrichment list --name new-policy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a fixed or recurring autoscale profile. (autogenerated)
    text: |
        az monitor autoscale profile create --autoscale-name MyAutoscale --count 2 --end 2018-12-26 --max-count 10 --min-count 1 --name Christmas --recurrence week sat sun --resource-group MyResourceGroup --start 2018-12-24 --subscription MySubscription --timezone "Pacific Standard Time"
    crafted: true
"""
...
aladdin_helps['network application-gateway auth-cert update'] = """
type: command
short-summary: Update an authorization certificate.
examples:
  - name: Update an authorization certificate. (autogenerated)
    text: az network application-gateway auth-cert update --cert-file /path/to/new/cert/file --gateway-name MyAppGateway --name MyAuthCert --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create an application gateway WAF policy. (autogenerated)
    text: az network application-gateway waf-policy create --location westus2 --name MyApplicationGatewayWAFPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['network asg create'] = """
type: command
...
aladdin_helps['network express-route create'] = """
type: command
...
examples:
  - name: Create an ExpressRoute circuit. (autogenerated)
    text: |
        az network express-route create --bandwidth 200 --name MyCircuit --peering-location "Silicon Valley" --provider "Equinix" --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a private link service. (autogenerated)
    text: az network private-link-service delete --name MyPrivateLinkService --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['network route-table update'] = """
type: command
short-summary: Update a route table.
examples:
  - name: Update a route table. (autogenerated)
    text: az network route-table update --name MyRouteTable --remove tags.no_80 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an A record set. (autogenerated)
    text: az network private-dns record-set a update --add communities='12076:5010' --name MyRecordSet --resource-group MyResourceGroup --set useRemoteGateways=true --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['mysql server replica list'] = """
type: command
short-summary: List all read replicas for a given server.
examples:
  - name: List all read replicas for a given server. (autogenerated)
    text: az mysql server replica list --resource-group testgroup --server-name testsvr --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a Redis cache. (autogenerated)
    text: az redis update --name MyRedisCache --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['relay namespace exists'] = """
type: command
short-summary: check for the availability of the given name for the Namespace
examples:
  - name: check for the availability of the given name for the Namespace (autogenerated)
    text: az relay namespace exists --name mynamespace --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Permanently stop data replication between two database replicas. (autogenerated)
    text: az sql db replica delete-link --name MyAzureSQLDatabase --partner-server newDb --resource-group MyResourceGroup --server myserver
    crafted: true
"""
...
examples:
  - name: Create the url to access a file. (autogenerated)
    text: az storage file url --account-key 00000000 --account-name MyAccount --path path/file.txt --share-name MyShare
    crafted: true
"""
...
aladdin_helps['image update'] = """
type: command
short-summary: Update custom VM images.
examples:
  - name: Update custom VM images. (autogenerated)
    text: az image update --name ImageName --resource-group ResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['vm image terms show'] = """
type: command
short-summary: Get the details of Azure Marketplace image terms.
examples:
  - name: Get the details of Azure Marketplace image terms. (autogenerated)
    text: az vm image terms show --subscription MySubscription --urn publisher:offer:sku:version
    crafted: true
"""
