...
examples:
  - name: Remove the ACI Connector from a managed Kubernetes cluster. (autogenerated)
    text: az aks remove-connector --connector-name MyConnector --graceful --name MyManagedCluster --os-type Windows --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Stop a live event (autogenerated)
    text: az ams live-event stop --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Show the details of a live output. (autogenerated)
    text: az ams live-output show --account-name MyAccount --live-event-name MyLiveEvent --name MyLiveOutput --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update an API Management service instance (autogenerated)
    text: az apim update --name MyApiManagementServiceInstance --resource-group MyResourceGroup --sku-name Developer --subscription MySubscription
    crafted: true
"""

aladdin_helps['appconfig feature set'] = """
type: command
short-summary: Set a feature flag.
examples:
  - name: Set a feature flag. (autogenerated)
    text: |
        az appconfig feature set --description "This is a colorful feature" --feature color --label MyLabel --name MyAppConfiguration --yes
    crafted: true
"""
...
examples:
  - name: Delete a deployment slot. (autogenerated)
    text: az functionapp deployment slot delete --name MyFunctionapp --resource-group MyResourceGroup --slot staging --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['webapp config access-restriction set'] = """
type: command
short-summary: Sets if SCM site is using the same restrictions as the main site.
examples:
  - name: Sets if SCM site is using the same restrictions as the main site. (autogenerated)
    text: az webapp config access-restriction set --name AppName --resource-group ResourceGroup --subscription MySubscription --use-same-restrictions-for-scm-site true
    crafted: true
"""
...
aladdin_helps['batchai cluster list'] = """
type: command
short-summary: List clusters.
examples:
  - name: List clusters. (autogenerated)
    text: az batchai cluster list --resource-group MyResourceGroup --subscription MySubscription --workspace MyWorkspace
    crafted: true
"""
...
aladdin_helps['batchai job list'] = """
type: command
short-summary: List jobs.
examples:
  - name: List jobs (autogenerated)
    text: az batchai job list --experiment MyExperiment --resource-group MyResourceGroup --subscription MySubscription --workspace MyWorkspace
    crafted: true
"""
...
aladdin_helps['cognitiveservices account network-rule add'] = """
type: command
...
examples:
  - name: Add a network rule. (autogenerated)
    text: az cognitiveservices account network-rule add --name MyAccount --resource-group myRg --subnet mysubnet --vnet-name MyVnet
    crafted: true
"""
...
examples:
  ...
  - name: Create an Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: |
        az cosmosdb cassandra table create --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --schema @indexes-file.json --subscription MySubscription --throughput "500"
    crafted: true
"""
...
aladdin_helps['eventhubs eventhub authorization-rule update'] = """
type: command
short-summary: Updates Authorizationrule for the given Eventhub
examples:
  - name: Updates Authorizationrule for the given Eventhub. (autogenerated)
    text: az eventhubs eventhub authorization-rule update --eventhub-name myeventhub --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --rights Manage --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['hdinsight monitor disable'] = """
type: command
short-summary: Disable the Azure Monitor logs integration on an HDInsight cluster.
examples:
  - name: Disable the Azure Monitor logs integration on an HDInsight cluster. (autogenerated)
    text: az hdinsight monitor disable --name MyCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Execute script actions on the specified HDInsight cluster (autogenerated)
    text: |
        az hdinsight script-action execute --cluster-name MyCluster --name MyScriptActionName --resource-group MyResourceGroup --roles headnode workernode --script-parameters '"-version latest -port 20000"' --script-uri https://hdiconfigactions.blob.core.windows.net/linuxgiraphconfigactionv01/giraph-installer-v01.sh
    crafted: true
"""
...
examples:
  - name: Update a route in IoT Hub. (autogenerated)
    text: az iot hub route update --condition true --hub-name MyIotHub --route-name R1
    crafted: true
"""
...
examples:
  ...
  - name: Update a classic metric-based alert rule. (autogenerated)
    ...
    crafted: true
  - name: Update a classic metric-based alert rule. (autogenerated)
    text: az monitor alert update --name MyAlertRule --resource-group MyResourceGroup --set retentionPolicy.days=365
    crafted: true
"""
...
examples:
  - name: Get a list of usage metrics for a workspace. (autogenerated)
    text: az monitor log-analytics workspace list-usages --resource-group MyResourceGroup --subscription MySubscription --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Update a frontend IP address. (autogenerated)
    text: az network application-gateway frontend-ip update --gateway-name MyAppGateway --name MyFrontendIp --private-ip-address 10.10.10.50 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a probe. (autogenerated)
    text: az network application-gateway probe delete --gateway-name MyAppGateway --name MyProbe --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a probe. (autogenerated)
    text: az network application-gateway probe update --gateway-name MyAppGateway --interval 10 --name MyProbe --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Remove a managed rule set by rule set group name if rule_group_name is specified (autogenerated)
...
examples:
  - name: Update properties of a web application firewall global configuration. (autogenerated)
    text: az network application-gateway waf-policy policy-setting update --policy-name MyPolicy --resource-group MyResourceGroup --state Disabled
    crafted: true
"""
...
examples:
  - name: Update a DDoS protection plan. (autogenerated)
    text: az network ddos-protection update --name MyDdosPlan --remove tags.no_80 --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['network dns record-set caa add-record'] = """
type: command
short-summary: Add a CAA record.
examples:
  - name: Add a CAA record. (autogenerated)
    text: |
        az network dns record-set caa add-record --flags 0 --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --tag "issue" --value "ca.contoso.com" --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty MX record set. (autogenerated)
    text: az network dns record-set mx create --if-none-match --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update settings of an ExpressRoute port (autogenerated)
    text: az network express-route port update --name MyExpressRoutePort --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a private link service. (autogenerated)
    text: az network private-link-service delete --name MyPrivateLinkService --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List all packet capture sessions within a resource group (autogenerated)
    text: az network watcher packet-capture list --location westus --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update an A record set. (autogenerated)
    text: az network private-dns record-set a update --name MyRecordSet --resource-group MyResourceGroup --set useRemoteGateways=true --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update a Redis cache. (autogenerated)
    text: az redis update --name MyRedisCache --resource-group MyResourceGroup --sku Basic --vm-size c0
    crafted: true
"""
...
examples:
  - name: Delete a resource-level lock. (autogenerated)
    text: az resource lock delete --ids /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Web/sites/{WebApp}
    crafted: true
"""

aladdin_helps['resource lock list'] = """
type: command
short-summary: List lock information in the resource-level.
examples:
  - name: List lock information in the resource-level (autogenerated)
    text: az resource lock list --resource-name myvnet --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Updates a Service Bus Namespace. (autogenerated)
    text: az servicebus namespace update --capacity 1 --name mynamespace --resource-group myresourcegroup --sku Basic
    crafted: true
"""

aladdin_helps['servicebus queue update'] = """
type: command
short-summary: Updates existing Service Bus Queue
examples:
  - name: Updates existing Service Bus Queue. (autogenerated)
    text: az servicebus queue update --name myqueue --namespace-name mynamespace --resource-group myresourcegroup --status Active
    crafted: true
"""
...
aladdin_helps['signalr list'] = """
type: command
short-summary: Lists all the SignalR Service under the current subscription.
examples:
  - name: Lists all the SignalR Service under the current subscription (autogenerated)
    text: az signalr list --resource-group MySignalR --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['sql instance-failover-group update'] = """
type: command
short-summary: Updates the instance failover group.
examples:
  - name: Updates the instance failover group. (autogenerated)
    text: az sql instance-failover-group update --failover-policy Automatic --location westus2 --name MyInstanceFailoverGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List directories in a share. (autogenerated)
    text: az storage directory list --account-key 00000000 --account-name MyAccount --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Grant a resource access to a managed disk. (autogenerated)
    text: az disk grant-access --access-level Read --duration-in-seconds 3600 --name MyManagedDisk --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Convert a VM with unmanaged disks to use managed disks. (autogenerated)
    text: az vm convert --name MyVm --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
