...
examples:
  - name: Create an Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb gremlin database create --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup --throughput "700"
    crafted: true
"""
...
aladdin_helps['dms list-skus'] = """
type: command
short-summary: List the SKUs that are supported by the Data Migration Service.
examples:
  - name: List the SKUs that are supported by the Data Migration Service. (autogenerated)
    text: az dms list-skus --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update an inbound NAT rule. (autogenerated)
    ...
    crafted: true
  - name: Update an inbound NAT rule. (autogenerated)
    text: az network lb inbound-nat-rule update --lb-name MyLb --name MyNatRule --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup --set tags.CostCenter=MyBusinessGroup
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the resource group is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of the resource group is met. (autogenerated)
    text: az group wait --created --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: List managed application definitions. (autogenerated)
    text: az managedapp definition list --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
